...
<body>
	...
	<div id="navigation">
		<ul>
			<li><a href="/test/includes/home.php">Home Page</a></li>
			<li><a href="/test/includes/publice_interface.php">Public Interface</a></li>
			<li><a href="/test/includes/member.php">Member</a></li>
            <li><a href="/test/includes/admin_interface.php">Admin Interface</a></li>
			<li><a href="/test/includes/password.php">Change Password</a></li>

<br />

​<?php
	// ECHO out a heading
             echo "<center><h1>Student</h1></center>";
?>         
...
<span class="test2">
	  <a href="student.php">Double click me</a>
	  <em tabindex="-1">&nbsp;</em>
	</span>
    <div id="footer">
